...
contract BuyFisc {
	...
	require(currentFiscAmount >= valueFisc, "Insufficient fisc quota."); 
    ...
    function changeFiscPercent(uint FiscPercent, uint UsdPercent) public onlyOwner {
        _fiscPercent= FiscPercent;
        _usdPercent= UsdPercent;
    }
